"use strict";
(self["webpackChunkuccss_old_new"] = self["webpackChunkuccss_old_new"] || []).push([["app-bdef046b"],{

/***/ "modules/tech/requests/apjRequests":
/*!**************************************************!*\
  !*** ./src/modules/tech/requests/apjRequests.js ***!
  \**************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   APJRequests: function() { return /* binding */ APJRequests; }
/* harmony export */ });
...
let APJRequests = (_dec = (0,aurelia_framework__WEBPACK_IMPORTED_MODULE_0__.inject)(_config_appConfig__WEBPACK_IMPORTED_MODULE_6__.AppConfig, _resources_utils_validation__WEBPACK_IMPORTED_MODULE_9__["default"], _resources_dialogs_common_dialogs__WEBPACK_IMPORTED_MODULE_1__.CommonDialogs, _resources_utils_dataTable__WEBPACK_IMPORTED_MODULE_2__.DataTable, _resources_utils_utils__WEBPACK_IMPORTED_MODULE_7__.Utils, _resources_data_products__WEBPACK_IMPORTED_MODULE_4__.Products, _resources_data_systems__WEBPACK_IMPORTED_MODULE_3__.Systems, _resources_data_people__WEBPACK_IMPORTED_MODULE_8__.People, _resources_data_apjClientRequests__WEBPACK_IMPORTED_MODULE_5__.APJClientRequests), _dec(_class = class APJRequests {
  ...
  async activate() {
    let responses = await Promise.all([this.products.getProductsArray('?filter=[and]active|eq|true:apj|eq|true&order=name', true), this.systems.getSystemsArray('?filter=apj|eq|true', true), this.config.getConfig(true)]);
    let uccRoles = "";
  ...
  async filterInAssigned() {
    ...
    if (this.isCheckedAssigned) {
      $('#loading').show();
      await this.clientRequests.getClientRequestsDetailsArray('?filter=[and]sessionId|eq|' + this.selectedSession + ':requestStatus|in|' + this.config.UNASSIGNED_REQUEST_CODE + '$' + this.config.UPDATED_REQUEST_CODE + '$' + this.config.CUSTOMER_ACTION_REQUEST_CODE, true);
      $('#loading').hide();
...
let ArchiveRequests = (_dec = (0,aurelia_framework__WEBPACK_IMPORTED_MODULE_0__.inject)(_config_appConfig__WEBPACK_IMPORTED_MODULE_6__.AppConfig, _resources_utils_dataTable__WEBPACK_IMPORTED_MODULE_1__.DataTable, _resources_utils_utils__WEBPACK_IMPORTED_MODULE_7__.Utils, _resources_data_sessions__WEBPACK_IMPORTED_MODULE_2__.Sessions, _resources_data_products__WEBPACK_IMPORTED_MODULE_4__.Products, _resources_data_systems__WEBPACK_IMPORTED_MODULE_3__.Systems, _resources_data_people__WEBPACK_IMPORTED_MODULE_8__.People, _resources_data_clientRequests__WEBPACK_IMPORTED_MODULE_5__.ClientRequests), _dec(_class = class ArchiveRequests {
  ...
  async activate() {
    let responses = await Promise.all([this.sessions.getSessionsArray('?filter=sessionStatus|eq|Closed&order=startDate:DSC', true), this.products.getProductsArray('?order=name'), this.systems.getSystemsArray(), this.config.getConfig()]);
    let uccRoles = "";
    this.config.ROLES.forEach(item => {
      if (item.UCConly) uccRoles += item.role + ":";
    });
...
let Assignments = (_dec = (0,aurelia_framework__WEBPACK_IMPORTED_MODULE_0__.inject)(_config_appConfig__WEBPACK_IMPORTED_MODULE_7__.AppConfig, _resources_utils_validation__WEBPACK_IMPORTED_MODULE_10__["default"], _resources_dialogs_common_dialogs__WEBPACK_IMPORTED_MODULE_1__.CommonDialogs, _resources_utils_dataTable__WEBPACK_IMPORTED_MODULE_2__.DataTable, _resources_utils_utils__WEBPACK_IMPORTED_MODULE_8__.Utils, _resources_data_sessions__WEBPACK_IMPORTED_MODULE_3__.Sessions, _resources_data_products__WEBPACK_IMPORTED_MODULE_5__.Products, _resources_data_systems__WEBPACK_IMPORTED_MODULE_4__.Systems, _resources_data_people__WEBPACK_IMPORTED_MODULE_9__.People, _resources_data_clientRequests__WEBPACK_IMPORTED_MODULE_6__.ClientRequests), _dec(_class = class Assignments {
  ...
  async activate() {
    let responses = await Promise.all([this.sessions.getSessionsArray('?filter=[in]sessionStatus[list]Active:Requests&order=sortOrder', true), this.products.getProductsArray('?filter=active|eq|true&order=name', true), this.systems.getSystemsArray('', true), this.config.getConfig(true)]);
    let uccRoles = "";
    this.config.ROLES.forEach(item => {
      if (item.UCConly) uccRoles += item.role + ":";
    });
  ...
  selectClient(index, client, el) {
    ...
    if (message) {
      return this.dialog.showMessage(message, "Confirm Assignment", ['Yes', 'No']).whenClosed(response => {
  ...
  validateIDRange(client, assignment, id) {
    ...
    client.assignments.forEach(item => {
      if (item.firstID === null || item.firstID == "" || item.lastID === null || item.lastID === "") {
        return this.dialog.showMessage("You must enter the ID range manually with this client.", "Manual Assignment", ['OK']).whenClosed(response => {
          return true;
        });
      }
    });
...
/***/ "modules/tech/requests/apjRequests.html":
/*!****************************************************!*\
  !*** ./src/modules/tech/requests/apjRequests.html ***!
  \****************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
//# sourceMappingURL=app-bdef046b.2384d3fce1a12a237460.bundle.js.map