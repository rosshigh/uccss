"use strict";
(self["webpackChunkuccss_old_new"] = self["webpackChunkuccss_old_new"] || []).push([["app-fc1603ca"],{
...
/* harmony import */ var fuelux__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! fuelux */ 9424);
/* harmony import */ var fuelux__WEBPACK_IMPORTED_MODULE_14___default = /*#__PURE__*/__webpack_require__.n(fuelux__WEBPACK_IMPORTED_MODULE_14__);
...
let CreateRequestTech = (_dec = (0,aurelia_framework__WEBPACK_IMPORTED_MODULE_0__.inject)(aurelia_router__WEBPACK_IMPORTED_MODULE_1__.Router, _config_appConfig__WEBPACK_IMPORTED_MODULE_7__.AppConfig, _resources_utils_validation__WEBPACK_IMPORTED_MODULE_10__["default"], _resources_data_people__WEBPACK_IMPORTED_MODULE_9__.People, _resources_dialogs_common_dialogs__WEBPACK_IMPORTED_MODULE_11__.CommonDialogs, _resources_utils_dataTable__WEBPACK_IMPORTED_MODULE_2__.DataTable, _resources_utils_utils__WEBPACK_IMPORTED_MODULE_8__.Utils, _resources_data_sessions__WEBPACK_IMPORTED_MODULE_3__.Sessions, _resources_data_products__WEBPACK_IMPORTED_MODULE_4__.Products, _resources_data_clientRequests__WEBPACK_IMPORTED_MODULE_6__.ClientRequests, _resources_data_siteInfo__WEBPACK_IMPORTED_MODULE_5__.SiteInfo, aurelia_event_aggregator__WEBPACK_IMPORTED_MODULE_13__.EventAggregator), _dec(_class = class CreateRequestTech {
  ...
  changeBeginDate(evt) {
    if (evt.detail && evt.detail.value.date !== "") {
      this.minEndDate = moment__WEBPACK_IMPORTED_MODULE_15___default()(evt.detail.value.date).format("MM/DD/YYYY");
      this.requests.selectedRequest.endDate = moment__WEBPACK_IMPORTED_MODULE_15___default().max(this.requests.selectedRequest.startDate, this.requests.selectedRequest.endDate);
    }
  }
  selectProduct(el) {
  ...
  async getRequests() {
    ...
    if (this.sessionId != -1 && this.courseId != -1) {
      ...
      if (this.requests.requestsArray && this.requests.requestsArray.length > 0) {
        ...
        if (this.requests.requestsArray && this.requests.requestsArray.length > 0) {
          let dateFoo = moment__WEBPACK_IMPORTED_MODULE_15___default()(new Date(this.requests.selectedRequest.requestDetails[0].createdDate)).format(this.config.DATE_FORMAT_TABLE);
...
let TechRequests = (_dec = (0,aurelia_framework__WEBPACK_IMPORTED_MODULE_0__.inject)(aurelia_router__WEBPACK_IMPORTED_MODULE_1__.Router, _config_appConfig__WEBPACK_IMPORTED_MODULE_2__.AppConfig), _dec(_class = class TechRequests {
...
let ViewUserRequests = (_dec = (0,aurelia_framework__WEBPACK_IMPORTED_MODULE_0__.inject)(_config_appConfig__WEBPACK_IMPORTED_MODULE_6__.AppConfig, _resources_data_people__WEBPACK_IMPORTED_MODULE_7__.People, _resources_utils_dataTable__WEBPACK_IMPORTED_MODULE_1__.DataTable, _resources_data_sessions__WEBPACK_IMPORTED_MODULE_2__.Sessions, _resources_data_products__WEBPACK_IMPORTED_MODULE_3__.Products, _resources_data_clientRequests__WEBPACK_IMPORTED_MODULE_5__.ClientRequests, _resources_data_systems__WEBPACK_IMPORTED_MODULE_4__.Systems), _dec(_class = class ViewUserRequests {
  ...
  async activate() {
    let responses = await Promise.all([this.sessions.getSessionsArray('?order=startDate:DSC', true), this.products.getProductsArray('?filter=active|eq|true&order=name', true), this.people.getInstitutionsArray('?filter=institutionStatus|eq|01&order=name'), this.systems.getSystemsArray(), this.config.getConfig()]);
    this.requests.selectRequest();
    this.filterList();
  }
  filterList() {
...
//# sourceMappingURL=app-fc1603ca.2384d3fce1a12a237460.bundle.js.map