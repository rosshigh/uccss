...
module.exports = function (app, config) {
  ...
  router.put('/helpTickets', asyncHandler(async (req, res) => {
    ...
    HelpTicket.findOneAndUpdate({ _id: req.body._id }, req.body, { new: true, safe: true, multi: false })
      .exec()
      .then(result => {
        res.status(200).json(result);
      })
  ...
  router.get('/helpTickets/archive/:id', requireAuth, function (req, res, next) {
  ...
  router.post('/helpTickets/archive/:collection', requireAuth, function (req, res, next) {
